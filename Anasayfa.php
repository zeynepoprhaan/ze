              ...
              <div class="container-fluid">
                <div class="row">
                  <div class="col-md-7">
                    <div class="detail-box">
                      <h1>
                        ZeZeBeauty İle Yüzünüzü Canlandırın <br>
                        
                      </h1>
                      <p>
                       İlk alışverişte %40 a varan indirimlerle
                      </p>
                      <a href="">
                        Bize Ulaşın
                      </a>
              ...
              <div class="container-fluid">
                <div class="row">
                  <div class="col-md-7">
                    <div class="detail-box">
                      <h1>
                        ZeZeBeauty İle kozmetik Bakımlarınıza Yenilik Ekeyin<br>
                      
                      </h1>
                      <p>
                        Aradıgınız parfüm, makyaj, cilt bakımı, saç bakımı, fondöten, eyeliner, yüz maskesi, makyaj setleri, maskara, oje, günes kremi, ruj, far, peeling ürünlerini ZeZeBeauty'de bulabilirsin.
                      <a href="">
                        Bize Ulaşın
                      </a>
                    </div>
      ...
      <div class="row">
        <div class="col-sm-6 col-md-4 col-lg-3">
          <div class="box">
            <a href="">
              <div class="img-box">
                <img src="images/tarte kapatıcı.jpg" alt="">
              </div>
              <div class="detail-box">
                <h6>
                  Kapatıcı
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
          <div class="box">
            <a href="">
              <div class="img-box">
                <img src="images/Summer Fridays.jpg" alt="">
              </div>
              <div class="detail-box">
                <h6>
                  Dudak Yağı
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
          <div class="box">
            <a href="">
              <div class="img-box">
                <img src="images/Starry Escape.jpg" alt="">
              </div>
              <div class="detail-box">
                <h6>
                  Allık kontur paleti
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
          <div class="box">
            <a href="">
              <div class="img-box">
                <img src="images/rare beauty fondoten.jpg" alt="">
              </div>
              <div class="detail-box">
                <h6>
                  fondoten
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
          <div class="box">
            <a href="">
              <div class="img-box">
                <img src="images/rare beauty highlighter.jpg" alt="">
              </div>
              <div class="detail-box">
                <h6>
                  Highlighter
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
          <div class="box">
            <a href="">
              <div class="img-box">
                <img src="images/nyx far.jpg" alt="">
              </div>
              <div class="detail-box">
                <h6>
                  Far
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
          <div class="box">
            <a href="">
              <div class="img-box">
                <img src="images/Kiko Milano Allık.jpg" alt="">
              </div>
              <div class="detail-box">
                <h6>
                  Allık
        ...
        <div class="col-md-4">
          <div class="box ">
            ...
            <div class="detail-box">
              ...
              <p>
                Toplam 1500TL veya Sephora Collection 1000TL üzeri alışverişlere ücretsiz kargo              </p>
            </div>
          </div>
        </div>
        <div class="col-md-4">
